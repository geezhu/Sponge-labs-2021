...
class TCPReceiver {
    ...
    uint64_t absolute_sequence_number_;
  ...
  public:
    ...
    TCPReceiver(const size_t capacity) : reassembler_(capacity), capacity_(capacity) ,isn_(std::nullopt),absolute_sequence_number_(0){}
